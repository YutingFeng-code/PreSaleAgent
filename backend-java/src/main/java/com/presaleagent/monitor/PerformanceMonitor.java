package com.presaleagent.monitor;
...
public class PerformanceMonitor {
    ...
    private final Counter contextCompactionTotal;
    private final Counter contextCompactionFailureTotal;
    private final Counter productFactViolationTotal;
    private final Counter catalogTimeoutTotal;
    private final Counter catalogCircuitOpenTotal;
    private final Counter toolBlockTotal;
    private volatile double agentSuccessRate = 1.0;

    public PerformanceMonitor(AgentOrchestrator orchestrator, KnowledgeToolManager toolManager, PreSaleAgentProperties properties, MeterRegistry meterRegistry) {
        this.orchestrator = orchestrator;
        this.toolManager = toolManager;
        this.properties = properties;
        Gauge.builder("presaleagent_agent_success_rate", () -> agentSuccessRate).register(meterRegistry);
        this.monitorCollections = Counter.builder("presaleagent_monitor_collections_total").register(meterRegistry);
        this.monitorCollectionTimer = Timer.builder("presaleagent_monitor_collection_duration").register(meterRegistry);
        this.contextCompactionTotal = Counter.builder("presaleagent_context_compaction_total").register(meterRegistry);
        this.contextCompactionFailureTotal = Counter.builder("presaleagent_context_compaction_failure_total").register(meterRegistry);
        this.productFactViolationTotal = Counter.builder("presaleagent_product_fact_violation_total").register(meterRegistry);
        this.catalogTimeoutTotal = Counter.builder("presaleagent_catalog_timeout_total").register(meterRegistry);
        this.catalogCircuitOpenTotal = Counter.builder("presaleagent_catalog_circuit_open_total").register(meterRegistry);
        this.toolBlockTotal = Counter.builder("presaleagent_tool_block_total").register(meterRegistry);
    }
    ...
    public Map<String, Object> summary() {
        return Map.of(
                ...
                "runtime_metrics", Map.of(
                        "context_compaction_total", contextCompactionTotal.count(),
                        "context_compaction_failure_total", contextCompactionFailureTotal.count(),
                        "product_fact_violation_total", productFactViolationTotal.count(),
                        "catalog_timeout_total", catalogTimeoutTotal.count(),
                        "catalog_circuit_open_total", catalogCircuitOpenTotal.count(),
                        "tool_block_total", toolBlockTotal.count()),
