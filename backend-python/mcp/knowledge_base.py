    ...
    def _load_default_docs(self) -> None:
        ...
        default_docs = [
            ...
            },
            {
                "title": "售前选购指南",
                "content": (
                    "选购时优先明确预算、使用场景、核心功能、尺寸限制和配送地点。"
                    "对比同类商品时，统一查看价格、规格、功能、适用人群、库存和配送。"
                    "礼品推荐需要了解收礼对象、关系、预算和使用习惯；信息不足时给出多个方向并说明取舍。"
                ),
            },
            {
                "title": "商品规格与事实边界",
                "content": (
                    "商品规格必须以对应型号的规格表为准，不同型号名称相似时先确认型号。"
                    "价格、库存、优惠和发货时效以当前商品目录或知识库结果为准。"
                    "没有可靠数据时必须明确说明，不能猜测或承诺。"
                ),
            },
            {
                "title": "商品 FAQ",
                "content": (
                    "商品是否有货、价格和预计发货时间以当前商品目录返回结果为准。"
                    "目录没有结果时，客服不能承诺库存或到货时间。"
                    "推荐结果是建议，不代表绝对最优，也不等同于下单或锁定库存。"
                ),
            },
        ]
